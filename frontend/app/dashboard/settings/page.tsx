                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid gap-2">
                        ...
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-primary" />
                          <span className="text-sm">Portfolio rebalances</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-primary" />
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="ml-auto text-xs text-muted-foreground">(Cannot be disabled)</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Higher security levels require additional verification for transactions
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 pt-2">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs text-muted-foreground">
                            Your wallet credentials are never stored. CrossMind uses secure, non-custodial connections to interact with your wallet.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-md border p-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-sm font-medium">Strategy Approval</h4>
                          <p className="mt-1 text-xs text-muted-foreground">
                            All AI-generated strategies require explicit approval before execution. Auto-approval can be enabled for strategies within your risk parameters.
                          </p>
                          <div className="mt-2 flex items-center gap-2">
                            <Switch id="auto-approve" />
                            <Label htmlFor="auto-approve" className="text-xs">Enable auto-approval for low-risk strategies</Label>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Allow CrossMind to automatically rebalance your portfolio
                        </p>
                      </div>
                      <Switch 
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="gasPreference">Gas Price Preference</Label>
                      <Select 
                        value={gasPreference} 
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="instant">Instant (Highest)</SelectItem>
                        </SelectContent>
                      </Select>
                      <p className="text-sm text-muted-foreground">
                        Select how quickly you want transactions to be processed
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="rounded-md border p-4 space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <Label htmlFor="max-transaction" className="text-sm">Maximum Transaction</Label>
                          ...
                          <div>
                            <Label htmlFor="daily-limit" className="text-sm">Daily Limit</Label>
                            <div className="relative mt-1">
                              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">
                                $
                              </span>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Set limits to control the maximum amount that can be transacted at once or within a day
                        </p>
                      </div>
                    </div>
                  </div>
