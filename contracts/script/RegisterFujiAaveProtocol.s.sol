...
contract RegisterFujiAaveProtocolScript is Script {
    function run() external {
        ...
        console.log("=== Registering AaveV3Adapter Protocol for Fuji ===");
        ...
        console.log("AaveV3Adapter protocol registered for Fuji!");
    }
}
